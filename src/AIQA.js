...
class AIQA {
  ...
  constructor(KEY, CHUNK_SIZE, doc) {
    return (async () => {
      ...
      this.#qa = ConversationalRetrievalQAChain.fromLLM(new OpenAI({openAIApiKey: KEY, temperature:0, modelName:"gpt-3.5-turbo"}), this.#vectorDB, {returnSourceDocuments:true});
      return this;
    })();
  }
  query(q,h) {
